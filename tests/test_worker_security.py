...
class TestWorkerRegistrationSecurity(unittest.TestCase):
    ...
    def test_valid_worker_registration(self):
        ...
        self.assertTrue(self.schema_validator.is_valid("worker_registration", valid_data))
    ...
    def test_invalid_worker_id(self):
        ...
        self.assertFalse(self.schema_validator.is_valid("worker_registration", invalid_data))
        errors = self.schema_validator.get_validation_errors("worker_registration", invalid_data)
    ...
    def test_heartbeat_validation(self):
        ...
        self.assertTrue(self.schema_validator.is_valid("worker_heartbeat", valid_heartbeat))
        ...
        self.assertFalse(self.schema_validator.is_valid("worker_heartbeat", invalid_heartbeat))
