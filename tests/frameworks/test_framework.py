...
class CustomTestSuite:
    ...
    def run(self) -> Dict[str, Any]:
        ...
        self.logger.info(f"Suite {self.name} completed: {passed} passed, "
...
class CustomTestRunner:
    ...
    def run_all(self) -> Dict[str, Any]:
        ...
        self.logger.info(f"Test run completed: {total_passed}/{total_tests} passed, "
...
def create_unit_test_case(name: str, test_func: Callable[[CustomTestResult], None]) -> CustomTestCase:
    """
...
def create_integration_test_case(name: str, test_func: Callable[[CustomTestResult], None]) -> CustomTestCase:
    """
...
def create_performance_test_case(name: str, test_func: Callable[[CustomTestResult], None]) -> CustomTestCase:
    """
