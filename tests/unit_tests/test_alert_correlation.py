...
def populate_test_alerts(db_file):
    ...
    yara_alerts = [
        (
            ...
            json.dumps({'severity': 3, 'description': 'Detected malicious executable'}),  # rule_meta
...
class TestAlertCorrelator:
    ...
    def test_correlate_alerts_ip_based(self, mock_get_connection_info, alert_correlator):
        ...
        ip_correlations = [g for g in correlated_groups if g.get('correlation_type') == 'ip_correlation']
    ...
    def test_correlate_alerts_hash_based(self, alert_correlator):
        ...
        hash_correlations = [g for g in correlated_groups if g.get('correlation_type') == 'hash_correlation']
    ...
    def test_correlate_alerts_time_proximity(self, alert_correlator):
        ...
        time_correlations = [g for g in correlated_groups if g.get('correlation_type') == 'time_proximity']
