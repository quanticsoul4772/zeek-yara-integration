...
class TestFileAnalyzer:
    ...
    def test_mime_type_detection(self, file_analyzer, test_files):
        ...
        assert file_analyzer.get_mime_type(test_files['paths']['binary.bin']) == 'application/octet-stream'
    ...
    def test_file_categorization(self):
        ...
        for mime_type, expected_category in test_cases:
            ...
            assert category == expected_category, f"Expected {expected_category} for {mime_type}, got {category}"
