...
class TestWorkflowConfiguration:
    ...
    def test_job_dependencies(self):
        ...
        if 'needs' in notification_job:
            ...
            for dep in expected_deps:
                assert dep in notification_job['needs'], f"Notification should depend on {dep}"
    ...
    def test_matrix_strategy(self):
        ...
        assert matrix['python-version'] == expected_python, f"Should test Python {expected_python}"
