...
'''
    ...
    def uninstall_windows_desktop(self):
        ...
        shortcuts_to_remove = [
            ...
            Path.home() / 'AppData' / 'Roaming' / 'Microsoft' / 'Windows' / 'Start Menu' / 'Programs' / 'Zeek-YARA Educational.lnk',
        ]
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Desktop Integration for Zeek-YARA Educational Platform")
