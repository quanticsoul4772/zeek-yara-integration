...
class IPCorrelationStrategy(CorrelationStrategy):
    ...
    def correlate(self, 
        ...
        for yara_alert in yara_alerts:
            ...
            if matching_alerts:
                # Deduplicate alerts
                unique_alerts = {f"{alert['source']}_{alert['id']}": alert for alert in matching_alerts}
    ...
    def correlate(self, 
        ...
        for suricata_alert in suricata_alerts:
            ...
            matching_alerts.extend(
                alert for md5, alerts in yara_by_md5.items() 
            ...
            matching_alerts.extend(
                alert for sha256, alerts in yara_by_sha256.items() 
...
class TimeProximityCorrelationStrategy(CorrelationStrategy):
    ...
    def correlate(self, 
        ...
        for yara_alert in yara_alerts:
            ...
            matching_alerts = [
                suricata_alert for suricata_alert in suricata_alerts
